...
MockRequest.addMock({
  ...
  params: {},
  response: apiFactory.build("slides", {
    number: 84
  })
});
...
MockRequest.addMock({
  ...
  params: {},
  response: apiFactory.build("personality", {
    number: 6
  })
});
...
MockRequest.addMock({
  ...
  params: {},
  response: apiFactory.build("personalityWithBlend", {
    number: 6
  })
});
...
MockRequest.addMock({
  ...
  params: "",
  response: apiFactory.build("personalityTraits", {
    number: 10
  })
});
...
MockRequest.addMock({
  ...
  params: "",
  response: apiFactory.build("careers", {
    number: 8
  })
});
